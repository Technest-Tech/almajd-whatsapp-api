...
/// Courses, Lessons, Teachers, Students Management placeholder page
class CoursesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BackButtonHandler(
      child: Scaffold(
        appBar: AppBar(
          title: Text(AppLocalizations.of(context)!.usersAndCourses),
        ),
        body: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Module name
                Text(
                  AppLocalizations.of(context)!.usersAndCourses,
